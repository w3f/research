...
**18.11.22**
    We have open sourced and published an `improvement to our BLS signature aggregation <https://github.com/w3f/bls/blob/skalman-double-puclic-key-verify/ChaumPedersenPoPs.pdf>`_ which allows for more efficient signature verification. We have submitted this work to `Financial Cryptography 2023 <https://fc23.ifca.ai/>`_.
**01.08.22**

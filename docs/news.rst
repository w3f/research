...
**18.11.22**
    We have open sourced and published an `efficiency improvement to our BLS signature aggregation <https://github.com/w3f/bls/blob/skalman-double-puclic-key-verify/ChaumPedersenPoPs.pdf>`_ by having public keys in both source groups of the BLS pairing and also adding Chaum-Pedersen proofs to individual signatures. We have submitted the work to `Financial Cryptography 2023 <https://fc23.ifca.ai/>`_
**01.08.22**

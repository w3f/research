...
Today, combinatorial auctions are applied in a wide range of contexts. Among the most well-known examples are radio spectrum auctions.[^2] [^3] Additional applications include electricity markets[^4], bus routes allocations, and industrial procurement.[^5] 

Many combinatorial auctions are dynamic, typically employing one of the following distinct formats:

1. *Ascending format*: While the auction remains open, bidders can submit progressively higher bids for the different packages.[^6]

2. *Clock format*: The auctioneer incrementally raises the prices of individual items or packages, and in each round, bidders must submit their demand for the different packages. In some versions and after the clock phase concludes, bidders are allowed to place final bids in an additional round of simultaneous bidding.[^7] 

:::note Information
U.S. radio spectrum auctions employed simple ascending multi-unit auctions for the first time. In 2006 and 2008, among other instances, the FCC introduced package bidding on predefined licenses using an ascending format.[^2] [^3] The transition to clock auctions occurred later.[^8]
:::
...
During the auction phase, the activity rule determines the feasible bids for each bidder. In the ascending bid format, the rule tipically specifies a minimum and a maximum increment that a new bid must have on a given item or package relative to a previous bid.[^9] In clock auctions, the activity rule may prevent bidders from switching to packages they ignored in earlier rounds; that is, bidders may reduce demand but not increase it.[^8] In both ascending and clock auctions, the rule may also restrict bidders to packages that are weakly smaller than those they previously bid on.[^2] 

The activity rule also determines when the auction ends based on all previously submitted bids. In an ascending auction, the auction closes once no new bids are placed in a given round.[^9] In a clock auction, prices for individual packages are raised simultaneously until there is no excess demand for any package, which is when the auction concludes.[^6] 
...
Originated in medieval Europe, the name "candle auctions" derive from the way they were conducted. The auctioneer would light a candle in view of all the bidders and accept bids until the flame extinguished. The highest bidder at the moment the candle went out was declared the winner.[^10] The earliest accounts of this kind of auction date back to 14th-century France, where they were used to sell chattels and leases. In England, furs were sold via candle auctions up to the 18th century.[^11] 
...
Consequently, experimental subjects can communicate via chat before each auction to discuss non-binding strategies. Specifically, both an open group chat and closed bilateral chats are available. These channels are accessible prior to the auction and close once it begins.
...
* Hyptothesis III: The candle format and the hard-close rule perform similarly in terms of efficiency and revenue. Efficiency may be slightly lower in the candle auction, while revenue may be slightly higher.
...
* Revenue: What was the total revenue generated? 
...
[^2]: Cramton, P. (2013). Spectrum auction design. Review of Industrial Organization, 42(2), 161-190.

[^3]: Porter, David, and Vernon Smith. “FCC license auction design: A 12-year experiment.” Journal of Law, Economics & Policy 3 (2006): 63.

[^4]: Meeus, Leonardo, Karolien Verhaegen, and Ronnie Belmans. “Block order restrictions in combinatorial electric energy auctions.” European Journal of Operational Research 196, No. 3 (2009): 1202-1206.

[^5]: For an overview look at Cramton, P., Shoham, Y., & Steinberg, R. (2006). Introduction to combinatorial auctions. Combinatorial auctions, 1-14.

[^6]: For an experimental study see Bichler, M., Hao, Z., & Adomavicius, G. (2017). Coalition-based pricing in ascending combinatorial auctions. Information Systems Research, 28(1), 159-179.

[^7]: Originally proposed by Ausubel, L. M., Cramton, P., & Milgrom, P. (2006). The clock-proxy auction: A practical combinatorial auction design. Combinatorial Auctions, 120-140. Further discussed in Cramton, P. (2013). Spectrum auction design. Review of Industrial Organization, 42(2), 161-190.

[^8]: Levin, J., & Skrzypacz, A. (2016). Properties of the combinatorial clock auction. American Economic Review, 106(9), 2528-51.

[^9]: Scheffel, T., Ziegler, G., & Bichler, M. (2012). On the impact of package selection in combinatorial auctions: an experimental study in the context of spectrum auction design. Experimental Economics, 15(4), 667-692.

[^10]: Hobson, A. (1971): A Sale by Candle in 1608," The Library, 5, 215-233.

[^11]: For more details and references see Füllbrunn, S. and A. Sadrieh (2012): \Sudden Termination Auctions|An Experimental Study," Journal of Economics & Management Strategy, 21, 519-540.

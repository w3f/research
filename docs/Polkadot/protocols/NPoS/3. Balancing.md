...
In light of this, and given that _star balancing_ is significantly easier to implement than the parametric flow-based algorithm, _star balancing_ is recommended for NPoS. 
...
and since $\Delta^r$ is non-negative, the claim is proved.
$$
\tag{$\blacksquare$}
$$
<br/>

...
\handan{Polkadot is a multi-chain system with shared security guarantees}{we use this sentence in couple of places. I think we need to explain with couple of sentences what the shared security means and implies.}. Polkadot consists of a main chain called the Relay Chain and multiple parallel chains

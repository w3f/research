...
The block production layer of the consensus is to be fast and probabilistically safe. \handan{Block production randomly and secretly assigns the production of each block to a certain block producer to mitigate denial of service and eclipse attacks}{Do we need to talk about it here? I think it makes more sense to say it in the beginning of \ref{sec:babe}}\syed{}{I think we should present an overview of the whole design of the relay-chain here and refer to Babe Grandpa sections for more details, that is inline in how the white paper was written} overview of building+BABE+grandpa. We should refer to those sections}. The detail of Polkadot block production consensus sub-protocol is described in Section \ref{sec:babe}.
...
\handan{}{I think we should integrate Block Building with BABE}\syed{}{same as above comment}
\eray{In this section}{-comment: This is not a section. Perhaps remove this phrase-}\syed{}{It is based on English definition of a section: 2. A subdivision of a written work. https://www.thefreedictionary.com/section I'm not refering to the latex syntax (which the reader might even know about) but the english meaning of the word} , we present a summary of various steps of relay chain operation. Validators of the relay-chain are nominated and get selected to produce and finalize a certain number of blocks known as an epoch. At the beginning of each epoch, each validator secretly knows the slot of the time which it is permitted and is supposed to produce a block.

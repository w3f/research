...
An alternative way to scale bockchain technologies are using side-chains. These solutions are also addressing interoperability, in that they enabling bridging side chains to the main chain. For example, Eth1.0 was made scalable by side-chains such as ....
A prominent solution that is based on bridging independent chains is Cosmos that is reviewed and compared to Polkadot next. 

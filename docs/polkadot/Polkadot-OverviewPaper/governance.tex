...
\eray{Bidder $B_1$ submits the bid (1-4,75 DOTs), bidder $B_2$ submits (3-4, 90 DOTs), and bidder $B_3$ submits (1-2, 30 DOTs).}{-comment: I do not understand the notation (3-4, 90 DOTs). -}

...
\begin{figure}[h]
	...
	\caption{\handan{This figure shows the relay chain with 5 relay chain blocks. For simplicity, in this figure each relay chain block has parachain blocks from 12 parachains, however, the number of parachain blocks per relay chain block might vary (Image credit: Ignasio Albero).}{we need the color and shape match with Figure 1}}

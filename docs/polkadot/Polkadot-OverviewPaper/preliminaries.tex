...
Polkadot was first introduced in 2016 by Gavin Wood \cite{2016:Wood:Polkadot} that layed the foundation for the following preliminary descriptions. 
...
and are likewise heavily \syed{staked}{define} and prone to be punished in case of offenses. \syed{}{in contrast see the comprehensive definition in the white paper page 4}
...
A collator produces new blocks and sends it to the parachain validators.

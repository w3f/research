...
To this end we designed an availability scheme that uses erasure coding \handan{\cite{}}{ref} to distribute the parachain PoV to all validators.
...
\eray{}{-comment: Why are these empty spaces between subsections?-}

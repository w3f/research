...
\subsubsection{Inter Chain Messaging Protocol (XCMP)} \label{sec:ICMP}
...
A parachain header contains a reference to the relay chain block, by block hash or block number, that the parachain block receives all messages up to and to the parachain id.

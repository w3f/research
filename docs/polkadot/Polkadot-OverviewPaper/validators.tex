...
Consensus protocols with deterministic finality, such as \handan{ours}{maybe it is better to use `in Polkadot' than saying `ours'}, require a set of registered validators of bounded size.

...
\newcommandx{\fatemeh}[2]{{\underline{#1}}\textcolor{pink}{(#2)}}
\newcommandx{\handan}[2]{{\underline{#1}}\textcolor{red}{(#2)}}
\newcommandx{\eray}[2]{{\underline{#1}}\textcolor{blue}{(#2)}}
\newcommandx{\jeff}[2]{{\underline{#1}}\textcolor{green}{(#2)}}
\newcommandx{\al}[2]{{\underline{#1}}\textcolor{cyan}{(#2)}}
\newcommandx{\sergey}[2]{{\underline{#1}}\textcolor{gray}{(#2)}}
\newcommandx{\alfonso}[2]{{\underline{#1}}\textcolor{purple}{(#2)}}
\newcommandx{\syed}[2]{{\underline{#1}}\textcolor{orange}{(#2)}}

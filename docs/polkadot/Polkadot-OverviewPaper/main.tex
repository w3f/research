...
\begin{abstract}
The blockchain 
In this paper we describe the design components of the heterogenous multi-chain protocol Polkadot.
We review the properties that Polkadot aims to achieve and explain all the components that are designed to achieve those properties.

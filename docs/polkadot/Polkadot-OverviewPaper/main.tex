...
\begin{abstract}
In recent years a vast number of blockchain projects have been introduced and employed with various features that are not necessarily designed to work  with each other.  This makes it difficult for user to utilise a large number of application on different block chain projects. Moreover, with the increase the number of projects the security each one is providing individually becomes weaker. In this paper we describe the design components of the heterogenous multi-chain protocol Polkadot and explain how  Polkadot addresses some of the existing shortcomings of blockchain technologies. 
\end{abstract}

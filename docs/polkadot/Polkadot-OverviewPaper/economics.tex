...
in \handan{normal circumstances}{what is  the difference btw normal and not normal circumstances}. In particular we do not consider rewards from transaction fees, slashings, nor rewards to fishermen 
...
the net token burning caused by the transaction fees and slashings mechanisms (see the section on \handan{Treasury}{reference to the section}). 

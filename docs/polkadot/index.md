...
These validators need to vote on the consensus over all the parachains, see the consensus scheme called [GRANDPA](https://github.com/w3f/research/blob/master/docs/polkadot/GRANDPA.md) for more details.

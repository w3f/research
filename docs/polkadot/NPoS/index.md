...
We are excited about the technical developments brought forward by Polkadot, and the possibilities enabled by NPoS and other highly efficient schemes being developed in the blockchain space. To learn more about the operations side of the problem of electing validators in NPoS, go to the [overview of our theoretical results](1. Overview.md). Visit our [Wiki pages](https://wiki.polkadot.network/docs/en/learn-staking) as well.

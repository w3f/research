...
Our proposed election rule is inspired in the $\phragmen$ method~\cite{brill2017phragmen}, and to the best of our knowledge corresponds to the first approximation algorithm for a Phragm\'{e}n method. 

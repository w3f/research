...
\DeclareMathOperator{\LSPJR}{PJRenabler}
...
\DeclareMathOperator{\balanced}{BalancedHeuristic}
...
\title{Validator Election in Nominated Proof-of-Stake}
\author{
  Alfonso Cevallos \\

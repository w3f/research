...
Any {\bf relay chain block producer} $U \in \vals$ with an upcoming relay chain block production slot enqueues any attested candidate receipts $\receipt_{B,S}$ with sufficient attestations $S$ received for possible inclusion in some future relay chain block that $U$ creates.  

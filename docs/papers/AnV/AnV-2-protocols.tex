...
We need pieces to be distributed before secondary checkers announce themsleves, so validators should announce when they receive all pieces required by any relay chain block $R$, but this announcement predates any GRANDPA votes. 

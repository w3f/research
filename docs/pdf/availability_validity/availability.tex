...
\end{itemize}
% TODO: We could remove the possibly distinct here but only be doing reconstruction, which actually should happen eventually, but we cannot realistically build upon $C$ in the mean time.
...
% TODO:  Is second condition redundant?
